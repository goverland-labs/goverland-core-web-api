...
require (
	...
	github.com/goverland-labs/goverland-core-storage/protocol v0.4.4
	github.com/goverland-labs/goverland-core-web-api/protocol v0.0.0-20250220123311-aafecc5e5171
